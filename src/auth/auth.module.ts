...
@Module({
    imports: [
        ...
        JwtModule.registerAsync({ // Importa o módulo JWT de forma assíncrona
            global: true, // Define este módulo como global
            inject: [ConfigService], // Injeta o serviço de configuração do NestJS

            useFactory(config: ConfigService<Env, true>) { // Define uma fábrica para criar as opções do módulo JWT
